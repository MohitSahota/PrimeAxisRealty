...
export default async function PropertiesPage({
  ...
  const filteredProperties = properties.filter((property) => {
    const selectedCategory = params.category || "residential";

    const matchesCategory = property.category === selectedCategory;
  ...
  return (
    <main className="min-h-screen px-3 md:px-6 py-2 overflow-x-hidden text-[var(--foreground)]">
      <div className="max-w-7xl mx-auto">
        {/* PROPERTY CATEGORY */}
        <div className="mb-6 flex justify-center">
          <div className="glassTabs">
            <Link
            ...
            <Link
              ...
              className={`glassTab ${
                params.category === "land" ? "activeGlass" : ""
              }`}
            >
              Land
            </Link>
            ...
            <Link
              ...
              className={`glassTab ${
                params.category === "commercial" ? "activeGlass" : ""
              }`}
            >
              Commercial
            </Link>
